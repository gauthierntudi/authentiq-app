...
<head>
    <meta charset="utf-8" />
    <title>Communes | Authentiq</title>
                    ...
                    <div class="col-12">
                        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Communes</h4>
                            </div>
                            <div class="mt-3 mt-sm-0">
                                <div class="row g-2 mb-0 align-items-center">
                                    <div class="col-auto">
                                        <button id="btnAddCommune" class="btn btn-lg btn-primary" style="border-radius: 15px;">
                ...
                <div class="row justify-content-center mt-4">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card p-3" style="border-radius:35px">
                          ...
                          <div class="card-body">
                            <div id="table-communes"></div>
                          </div>
                        </div>

                        <!-- Modal ajout / édition commune -->
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content" style="border-radius:35px!important">
                              <div class="modal-header text-bg-primary border-0" style="border-top-left-radius:35px!important;border-top-right-radius:35px!important">
                                <h5 class="modal-title" id="communeModalTitle">Ajouter / Modifier commune
                                <br> 
                                <span class="fw-normal" style="font-size: .8em;">Faites des opérations sur les communes</span>
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                              </div>
                              <div class="modal-body">
                                <form id="formCommune">
                                  <input type="hidden" id="communeId">
                                  <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="communeNom" required>
                                    <label for="communeNom" class="form-label">Nom de la commune</label>
                                  </div>
                                  <div class="form-floating mb-3">
                                    <select class="form-select" id="communeVille" required></select>
                                    <label for="communeVille" class="form-label">Ville</label>
                                  </div>
                                  <div class="modal-footer border-0">
                                       <a class="btn btn-light fw-semibold" data-bs-dismiss="modal" style="border-radius:12px">Close</a>
                                       <button type="submit" id="communeSubmit" class="btn btn-primary fw-semibold" style="border-radius:12px">Enregistrer</button>
                                   </div>
                                </form>
                              </div>
                            </div>
...
<!-- Theme Settings -->
    ...
    <script src="{{ asset('ajax/gridCommunes.js') }}"></script>
