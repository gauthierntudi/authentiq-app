            ...
            t.addEventListener("click", () => {
                {
                    ...
                    (a.innerHTML = [`<div class="alert alert-${t} alert-dismissible" role="alert">`, `   <div>${e}</div>`, '   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', "</div>"].join(
                        ""
                    )),
                        n.append(a);
                }
        ...
        $(".side-nav").length &&
            ...
            $(".side-nav a").each(function () {
                ...
                this.href == e &&
                    ...
                    (e = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || e.addClass("active"));
            }),
            setTimeout(function () {
                var e,
                    n,
                ...
                function d() {
                    ...
                    var e,
                        t,
                        a = (e /= i / 2) < 1 ? (a / 2) * e * e + t : (-a / 2) * (--e * (e - 2) - 1) + t;
...
class ThemeCustomizer {
        ...
        $("#two-col-sidenav-main").length &&
            ...
            $("#two-col-menu a").each(function () {
                ...
                this.href == o &&
                    ...
                    (e = $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is("body") || e.addClass("active"),
                    (t = null),
                    (a = "#" + $(this).parents(".sidenav-menu-item").attr("id")),
    ...
    initSwitchListener() {
                ...
                (e &&
                    e.addEventListener("click", function () {
                        ...
                        "full" === t
                            ...
                            : "fullscreen" == e
                            ? "fullscreen" === t
                                ? a.changeLeftbarSize("fullscreen" == e ? "default" : e, !1)
                                : a.changeLeftbarSize("fullscreen", !1)
                            : "condensed" === t
                            ? a.changeLeftbarSize("condensed" == e ? "default" : e, !1)
        ...
        e &&
            ...
            document.querySelectorAll(".button-sm-hover").forEach(function (e) {
                e.addEventListener("click", function () {
                    var e = a.config.sidenav.size;
                    "sm-hover-active" === a.html.getAttribute("data-sidenav-size", e) ? a.changeLeftbarSize("sm-hover", !1) : a.changeLeftbarSize("sm-hover-active", !1);
                });
            });
    }
    showBackdrop() {
    ...
    _adjustLayout() {
        ...
        window.innerWidth <= 767.98
            ...
            ? "full" !== e.config.sidenav.size && "fullscreen" !== e.config.sidenav.size && ("sm-hover" === e.config.sidenav.size ? e.changeLeftbarSize("condensed") : e.changeLeftbarSize("condensed", !1))
            : (e.changeLeftbarSize(e.config.sidenav.size), e.changeLayoutMode(e.config.layout.mode));
    }
    setSwitchFromConfig() {
        sessionStorage.setItem("__AUTHENTIQ_CONFIG__", JSON.stringify(this.config)),
        ...
        o &&
            ...
            (a = document.querySelector("input[type=radio][name=data-layout-mode][value=" + o.layout.mode + "]")),
            (n = document.querySelector("input[type=radio][name=data-topbar-color][value=" + o.topbar.color + "]")),
            (i = document.querySelector("input[type=radio][name=data-menu-color][value=" + o.menu.color + "]")),
            (o = document.querySelector("input[type=radio][name=data-sidenav-size][value=" + o.sidenav.size + "]")),
            e && (e.checked = !0),
            t && (t.checked = !0),
            a && (a.checked = !0),
            n && (n.checked = !0),
    ...
    init() {
        this.initConfig(), this.initTwoColumn(), this.initSwitchListener(), this.initWindowSize(), this._adjustLayout(), this.setSwitchFromConfig();
    }
}
    ...
    document.addEventListener("mousemove", function (t) {
        clearTimeout(e),
            (e = setTimeout(function () {
                var e = new CustomEvent("mousestop", { detail: { clientX: t.clientX, clientY: t.clientY }, bubbles: !0, cancelable: !0 });
